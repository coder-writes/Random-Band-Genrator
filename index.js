...
app.post("/submit", (req, res) => {
  ...
  var randomNumber1 = Math.round(Math.random()*adj.length);
  var randomNumber2 = Math.round(Math.random()*noun.length);
  var bandName = adj[randomNumber1]+"-"+noun[randomNumber2];
